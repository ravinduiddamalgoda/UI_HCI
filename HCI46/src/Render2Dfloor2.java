...
public class Render2Dfloor2 extends JFrame implements GLEventListener, MouseListener, MouseMotionListener {
    ...
    public Render2Dfloor2(float tableScale , float chairScale , float cupboardScale , String tableColor , String chairColor , String cupColor ) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            Render2Dfloor2 renderer = new Render2Dfloor2(1 , 1 , 5 , "red" , "brown" , "blue");
