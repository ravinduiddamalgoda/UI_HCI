...
public class FurnitureRenderer extends JFrame implements GLEventListener, MouseListener, MouseMotionListener {
    ...
    public FurnitureRenderer(float tableScale , float chairScale , float cupboardScale , String tableColor , String chairColor , String cupColor ) {
