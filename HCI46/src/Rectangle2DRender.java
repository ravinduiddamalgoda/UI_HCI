...
public class Rectangle2DRender extends JFrame implements GLEventListener, MouseListener, MouseMotionListener {
    ...
    public Rectangle2DRender(float tableScale , float chairScale , float cupboardScale , String tableColor , String chairColor , String cupColor ) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            FurnitureRenderer renderer = new FurnitureRenderer(1 , 1 , 5 , "red" , "brown" , "blue");
    ...
    private  void drawFloorSq(GL2 gl){
        // Draw floor
        gl.glColor3f(0.8f, 0.8f, 0.8f); // Light gray color for the floor
